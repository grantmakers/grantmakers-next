      ...
      <div class="container-custom">
        ...
        <div class="row">
          <div class="col s8 m6 l2 xl2">
            <a href={site.url} data-ga="Homepage" class="brand-logo">
          ...
          <div class="col l4 xl5 hide-on-med-and-down valign-wrapper" style="height: 64px">
            <div class="breadcrumb-wrapper left">
              <a href="{site.url}/search/profiles/" class="breadcrumb hide-on-large-and-down" data-ga="Breadcrumb Profile Search"
...
<ul class="dropdown-content dropdown-content-profile" id="navbar-more">
  ...
  <li>
    <a href="{site.url}/search/profiles/" class="waves-effect waves-light" data-ga="Profiles Search" title="Profiles Search"
      >Profiles Search</a
    >
  </li>
  <li>
    <a href="{site.url}/search/grants/" class="waves-effect waves-light" data-ga="Grants Search" title="Grants Search">Grants Search</a>
  </li>
  <li class="divider"></li>
  <li><a href="{site.url}/about/" class="waves-effect waves-light" data-ga="About" title="About">About</a></li>
  <li><a href="{site.url}/about/faq/" class="waves-effect waves-light" data-ga="FAQ" title="FAQ">FAQ</a></li>
  <li class="divider"></li>
  <li class="dropdown-bottom-cta grey darken-3 white-text">
    <a href="{site.url}/buy-chad-a-coffee/" class="waves-effect waves-light small" data-ga="Coffee" title="Buy Chad a Coffee"
...
<ul class="nav-primary sidenav sidenav-close" id="mobile-nav">
  <li class="grey darken-3 sidenav-header">
    <a href="{site.url}/" class="waves-effect waves-light" data-ga="Home">
            ...
            <div id="profile" class="profile center-align">
              ...
              <div class="name">
                <h1
                  ...
                  data-url="{site.url}{site.baseurl}/{page.ein}/"
