<script lang="ts">
  import logo from '$lib/assets/legacy/images/logo.png';
  const site = {
    baseurl: '',
...
<ul class="dropdown-content" id="navbar-more">
  ...
  <li><a href="{site.baseurl}/about/donate/" class="waves-effect waves-light" data-ga="Donate" title="Donate">Donate</a></li>
</ul>
<!-- End navbar dropdown -->
