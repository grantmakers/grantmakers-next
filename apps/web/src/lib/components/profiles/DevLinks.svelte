  ...
  <div class="mx-auto">
    ...
    <div class="instructions mt-12 flex items-start justify-between gap-6">
      <div class="flex flex-col gap-2 whitespace-nowrap">
        ...
        <a href="/profiles/v1/510381959"><code>Harnisch Family Foundation</code></a>
        <a href="/profiles/v1/131684331"><code>Ford Foundation</code></a>
      ...
      <div class="flex flex-col gap-2 whitespace-nowrap">
        <h2 class="mb-4 w-full border-b text-base">Sparse data</h2>
        <a href="/profiles/v1/010212437"><code>McArthur Home for Aged People Assoc</code></a>
    ...
    <div class="mt-12 flex w-full flex-col justify-center gap-2">
      ...
      <a href="/profiles/v1/010238086"><code>Cape Elizabeth Home</code></a>
