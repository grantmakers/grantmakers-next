...
<div class="relative bg-white">
  <main>
    ...
    <div class="relative isolate overflow-hidden bg-gray-900 pt-14 lg:-top-24">
      ...
      <!-- Background gradient -->
      <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-none sm:-top-80 lg:blur-3xl" aria-hidden="true">
        <div
      ...
      <div
        class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-none sm:top-[calc(100%-30rem)] lg:blur-3xl"
        aria-hidden="true"
      >
        <div
