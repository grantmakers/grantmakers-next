...
<div class="relative isolate overflow-hidden bg-gray-900 px-6 py-20 sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
  ...
  >
    ...
    <img
      ...
      class="relative -z-20 min-w-full rounded-xl shadow-xl lg:row-span-4 lg:w-lg lg:max-w-none"
      width="536"
      height="483"
    />
    <div class="max-w-xl lg:row-start-3 lg:mt-10 lg:max-w-md lg:border-t lg:border-white/10 lg:pt-10">
      <dl class="max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
        ...
        <div class="relative">
          ...
          <dd class="inline">When you need the robustness of the industry leader (and can afford it).</dd>
        </div>
        <div class="relative">
          <dt class="ml-9 inline-block font-semibold text-white">
            <svg class="absolute left-1 top-1 h-5 w-5 text-indigo-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          ...
          <dd class="inline">A full grants management platform when you're ready to level up.</dd>
        </div>
      </dl>
    </div>
  </div>
  <div
    class="pointer-events-none absolute left-12 top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-3xl lg:-bottom-48 lg:top-auto lg:translate-y-0 lg:transform-gpu"
    aria-hidden="true"
  >
    <div
