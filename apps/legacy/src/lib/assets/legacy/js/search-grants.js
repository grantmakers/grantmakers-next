...
export function initSearchJs(M) {
  ...
  const templateHits = `<div class="row row-grant-names">
    ...
    <div class="col s12 m5">
      <a class="truncate text-light" data-sveltekit-reload href="/profiles/v0/{{ ein }}-{{ organization_name_slug }}" title="View foundation profile">{{ organization_name }}</a>
    </div>
    <div class="col m1 hide-on-small-only">
      <div class="actions-wrapper center-align">
        ...
        <ul id="{{ _id }}" class='dropdown-content'>
          <li><a data-sveltekit-reload href="/profiles/v0/{{ ein }}-{{ organization_name_slug }}"><i class="material-icons md-18 left">list_alt</i>View Foundation Profile</a></li>
        </ul>
      </div>
    </div>
  </div>
