  ...
  const templateHits = `  <div class="card">
    <div class="card-content">
      ...
      <span class="card-title">
        ...
        <a class="hit-name" data-sveltekit-reload href="/profiles/v0/{{ ein }}" title="View Profile">{{#helpers.highlight}}{ "attribute": "organization_name" }{{/helpers.highlight}}</a>
        {{/_highlightResult.organization_name}}
        {{^_highlightResult.organization_name}}
        <a class="hit-name" data-sveltekit-reload href="/profiles/v0/{{ ein }}" title="View Profile">{{{organization_name}}}</a>
        {{/_highlightResult.organization_name}}
      </span>
